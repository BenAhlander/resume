  ...
  return (
    <React.Fragment>
      ...
      <Grid container justify="center">
        ...
        <Grid item xs={12}>
          <Button variant="contained" color="primary" fullWidth onClick={()=>openInNewTab("https://www.chunker.com/")}>visit Chunker</Button>
        </Grid>
      </Grid>
    </React.Fragment>
  );
...
function NinjaSkillGames() {
  return (
    <React.Fragment>
      ...
      <Grid container justify="center">
        <Grid item xs={12} sm={12} md={12}>
          <ImageStepper listImages={listImages2} />
        </Grid>
      </Grid>
      <Grid container justify="center">
        <Grid item xs={12} style={{ marginBottom: "16px", marginTop: "16px" }}>
          <Typography>
            NinjaSpaceMonkey is created using the serverless AWS Amplify stack.
        ...
        <Grid item xs={12}>
          <Button variant="contained" color="primary" fullWidth onClick={()=>openInNewTab("https://www.ninjaspacemonkey.com/")}>visit NinjaSpaceMonkey</Button>
        </Grid>
      </Grid>
    </React.Fragment>
  );
